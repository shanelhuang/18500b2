...
if __name__ == '__main__':
    ...
    while True:
        ...
        if len(distances) > MIN_SAMPLES:
            slam.update(distances, pose_change = ( (40, 0, time.time() - prevTime)),scan_angles_degrees=angles)
            prevTime = time.time()
        ...
        # If not adequate, use previous
            ...
            slam.update(previous_distances, pose_change = ( (40, 0, time.time() - prevTime)),scan_angles_degrees=previous_angles)
            prevTime = time.time()
            print("updated - else")
